                    ...
                    [
                      {
                        ...
                        desc:"AI adjust difficult based on selected job role."
                      },
                      {
                        icon:<BsMic size={24}/>,
                        step:"STEP 2",
                      ...
                      },
                      {
                        ...
                        desc:"Real interview presures with time tracking."
                      }
                    ].map((item,index)=>(
                    ...
                    ${index === 2 ? "rotate-[-3deg] " : ""}
                      `}>
                        ...
                        <div className="pt-10 text-center">
                          <div className="text-green-500">{item.step}</div>
                          <h3 className="font-semibold mt-3 text-1xl">{item.title}</h3>
                  ...
                  [
                    {
                      ...
                      desc:"Behavioral and communication based eveluation ."
                    ...
                    {
                      img: confidenceImg,
                      title:"Confience Detection ",
                      desc:"Basic tone and voice analysis sessions easily ."
