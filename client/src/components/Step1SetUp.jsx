...
const Step1SetUp = ({ onStart }) => {
  ...
  return (
    ...
    >
      <div className="w-full max-w-[1200px] bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden">
        <motion.div
            ...
            {[
              ...
              return (
                <motion.div
                  ...
                  key={index}
                  className="flex items-center space-x-4 bg-white p-4 rounded-xl shadow-xl shadow-sm cursor-pointer"
                >
                  {item.icon}
          ...
          <div className="space-y-6">
            ...
            {!analysisDone && (
              <motion.div
                ...
                className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center cursor-pointer  hover:border-green-800 hover:bg-green-100 "
              >
