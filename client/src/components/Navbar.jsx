            ...
            <div className='flex items-center gap-6 relative'>
                <div className='relative'>
                    ...
                    {showCreditPopup && (
                        <div className='absolute right=[50px] mt-3 w-64 bg-white shadow-xl border border-gray-200 rounded p-5 z-50'>
                            <p className='text-sm text-gray-600 mb-4'>Need more credits t continue interviews?</p>
                ...
                <div className='relative'>
                    <button onClick={()=> {
                        ...
                        setShowCreditPopup(false)
                    } }className='w-9 h-9 items-center gap-2 bg-black text-white rounded-full flex items-center justify-center font-semibold'>
