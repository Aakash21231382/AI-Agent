...
import { useEffect } from "react";
  ...
  const speakText = (text) =>{
    return new Promise((resolve) => {
      ...
      // Add natural puases after commas and periods   
    ...
    utterance.onend = () => {
      ...
      //resolve();   // subtitle remove मत करो
  ...
  useEffect(() => {
    ...
    setAnswer("");           // previous answer clear
    setFeedback("");         // previous feedback clear
    setIsSubmitting(false);  // button reset (main fix)
...
const toggleMic = () =>{
  ...
  return (
    <>
      {/* mount - load voice - question speak - mic on - timer running - submit- feedback speak - next question - repeat - finish */}
      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-100 flex items-center justify-center p-4 sm:p-6">
        <div className="w-full max-w-[1200px] min-h-[90px] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden">
          {/* vodeo section  */}
...
/>
            ...
            <div className="w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-md p-6 space-y-5">
              ...
              <div className="flex justify-center ">
                ...
                <Timer key={currentIndex} timeLeft={timeLeft} totalTime={currentQuestion?.timeLimit || 60} />
              </div>
         ...
         {!isIntroPhase &&   (<div className="relative mb-6 bg-gray-50 p-4 sm:p-6 rounded-2xl border border-gray shadow-sm">
            ...
            <textarea
              ...
              value={answer}
              className="flex-1 bg-gray-100 not-visited:p-4 sm:p-6 rounded-2xl  resize-none outline-none border border-gray-200 focus:ring-2 focus:ring-emerald-500 transition text-gray-800"
            ></textarea>
...
//       <div className="w-full max-w-[1200px] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden">
...
//           <textarea
//             placeholder="Type your answer here..."
//             className="flex-1 p-6 rounded-2xl resize-none outline-none border border-gray-200 focus:ring-2 focus:ring-emerald-500"
//           />
...
//             <motion.button
//               whileTap={{ scale: 0.95 }}
//               className="flex-1 bg-gradient-to-r from-emerald-600 to-teal-500 text-white py-4 rounded-2xl font-semibold"
//             >
//               Submit Answer
//             </motion.button>
